---
title: "Create County-Average Corn Nitrogen-Balance Estimates from Public Datasets"
author: "Kenneth Qin"
...
Of course, these non-corn/soy crops only make up to `r 1-THRESHOLD_CORNSOY` of total acreage in these counties.
...
Specifically, we will look at corn fertilizer rates. This means that in the EPA EPA-derived fertilizer application estimates, we will only use counties where over `r THRESHOLD_CORNSOY` of acreage consists of corn/soybean.
